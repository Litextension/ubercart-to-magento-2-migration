# ubercart-to-magento-2-migration
=== UberCart to Magento 2.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension
Download: https://litextension.com/magento-2-x-migration/ubercart-to-magento-2-migration.html


== Description ==
LitExtension UberCart to Magento 2.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from UberCart to Magento 2.x automatically.
